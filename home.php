  ...
  <div class="container">
    ...
    <div class="services__inner">
      <div class="services__content">
        <?php the_field('servise-txt')?>
      </div>
      <?php the_field('servise-item')?>
    </div>
  </div>
</section>
...
<section class="benefits">
  <div class="container">
    <div class="benefits__inner">
      <img data-wow-delay="2s" class="benefits__images wow animate__fadeInUp" src="<?php the_field('image-car-roof');?>">
      <div class="benefits__content">
        <h2 class="title benefits__title">ПОЧЕМУ МЫ?</h2>
        <?php the_field('text-adventage');?>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="contacts__inner">
      ...
      <form class="contacts__form">
        <h2 class="title contacts__title">Оставить заявку</h2>
           <?php echo do_shortcode( '[contact-form-7 id="2e94c1c" title="Контактна форма"]' ) ?>
      </form>
    </div>
  </div>
</section>
